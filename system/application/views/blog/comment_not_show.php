        ...
        ?>    
            <tr>
                ...
                <td><li style="list-style-type:none">
                        <div align="center"><label><a href="<?php echo site_url('blog/edit_comment').'/'.$id.'/'.$idbog.'/'.$Status.'/'.$CountComment?>" onclick="return confirm('<?php echo __("CF_mess_approved")?>')"><?php echo __("CF_edit")?></a></label></div>
                    </li>
