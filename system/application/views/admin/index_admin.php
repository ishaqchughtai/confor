...
?><div class="x2 frame">
    ...
    <ul class="link_conttrol">
        ...
        <li><a class="icon_setting" href="<?php echo site_url('xmlvideo')?>"><?php echo __("CF_player_vid_set")?></a></li>
        <li><a class="icon_profile" href="<?php echo site_url('metadata/get_metadata_static/home/'.$lang)?>"><?php echo __("CF_edit_home_meta")?></a></li>
        <li><a class="icon_profile" href="<?php echo site_url('writexml/get_video')?>"><?php echo __("CF_update_sitemap")?></a></li>
    </ul>        
