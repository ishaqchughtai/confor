        ...
        <form >
          ...
          <ol>
            <li> <img src="<?php echo base_url().'assets/uploads/image/'.$linktemp?>" alt="XemmeX" width="80" height="80" class="comment_image" />
              <!-- Author Image -->
              <p class="content"> <a href="<?php echo $site?>" class="author"><?php echo $author?></a>
                <!-- Author -->
              ...
              <!-- Content -->
              <?php if($status==0){?>
              <a href="<?php echo site_url('blog/edit_comment'.'/'.$titletemp.'/'.$id.'/'.$idtemp.'/'.$countcommenttemp.'/'.$authortemp)?>" class="reply">Show Comment</a>
              <?php }?>
              <br />
              <a href="<?php echo site_url('blog/delete_comment'.'/'.$titletemp.'/'.$id.'/'.$idtemp.'/'.$countcommenttemp.'/'.$authortemp)?>" class="reply">Delete Comment</a> </li>
            <!-- /#comments ol li -->
          </ol>
          <!-- /#comments ol -->
          <?php }?>
