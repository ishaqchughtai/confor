...
?>
		...
		<h2><?php echo strtoupper(__("CF_new_speaker"))?></h2>		
		<?php echo form_open('admin/new_speaker');?>
	    ...
	    <p class="not_error medium"><span class="img"></span><?php echo $error;?><span class="close"></span></p>			
			...
			<input type="submit" class="submit" name="submit" value="<?php echo strtoupper(__("CF_add"))?>">
