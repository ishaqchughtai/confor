		...
		<div id="image_box">
			...
			foreach($images as $image){ 
				...
				<li id="image_<?php echo $image_id;?>"<?php if($image_id>0)echo ' style="display:none;"';?>>
					<a href="<?php echo $image;?>" title="Click here to preview the image" target="_blank"><img src="<?php echo $image;?>" border="0"></a>
				</li>
				<?php 
				$image_id++;
			} 
			...
			<span id="images_none" style="display:none;">
				<input type="checkbox" name="no_image" id="no_image" value="true"> <span>no image</span>
			</span>
		</div>
