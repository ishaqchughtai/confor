<?php /* Smarty version 2.6.20, created on 2010-07-11 13:57:05
         compiled from /home/conferen/public_html/prestashop/themes/confor/shopping-cart.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/home/conferen/public_html/prestashop/themes/confor/shopping-cart.tpl', 7, false),array('function', 'displayPrice', '/home/conferen/public_html/prestashop/themes/confor/shopping-cart.tpl', 57, false),array('modifier', 'escape', '/home/conferen/public_html/prestashop/themes/confor/shopping-cart.tpl', 28, false),array('modifier', 'intval', '/home/conferen/public_html/prestashop/themes/confor/shopping-cart.tpl', 184, false),array('modifier', 'secureReferrer', '/home/conferen/public_html/prestashop/themes/confor/shopping-cart.tpl', 274, false),)), $this); ?>
		...
		<?php if ($this->_tpl_vars['product']['id_product'] == $this->_tpl_vars['lastProductAdded']['id_product'] && ( ! $this->_tpl_vars['product']['id_product_attribute'] || ( $this->_tpl_vars['product']['id_product_attribute'] == $this->_tpl_vars['lastProductAdded']['id_product_attribute'] ) )): ?>
			<div class="cart_last_product">
				<div class="cart_last_product_header">
					<div class="left"><?php echo smartyTranslate(array('s' => 'Last added product'), $this);?>
</div>
				</div>
				<a  class="cart_last_product_img" href="<?php echo ((is_array($_tmp=$this->_tpl_vars['link']->getProductLink($this->_tpl_vars['product']['id_product'],$this->_tpl_vars['product']['link_rewrite'],$this->_tpl_vars['product']['category']))) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
...
<p><?php echo smartyTranslate(array('s' => 'Your shopping cart contains'), $this);?>
 ...
 <?php if ($this->_tpl_vars['productNumber'] == 1): ?><?php echo smartyTranslate(array('s' => 'product'), $this);?>
...
<div id="order-detail-content" class="table_block">
	<table id="cart_summary" class="std">
		...
		<tfoot>
			<?php if ($this->_tpl_vars['use_taxes']): ?>
			...
			<?php else: ?>
				<tr class="cart_total_price">
					<td colspan="6"><?php echo smartyTranslate(array('s' => 'Total products:'), $this);?>
</td>
					<td class="price"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['total_products']), $this);?>
</td>
				</tr>
			...
			<?php if ($this->_tpl_vars['total_discounts'] != 0): ?>
				...
				<?php else: ?>
					<tr class="cart_total_voucher">
						<td colspan="6"><?php echo smartyTranslate(array('s' => 'Total vouchers:'), $this);?>
</td>
						<td class="price-discount"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['total_discounts_tax_exc']), $this);?>
</td>
					</tr>
			...
			<?php if ($this->_tpl_vars['total_wrapping'] > 0): ?>
				...
				<?php else: ?>
					<tr class="cart_total_voucher">
						<td colspan="6"><?php echo smartyTranslate(array('s' => 'Total gift-wrapping:'), $this);?>
</td>
						<td class="price-discount"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['total_wrapping_tax_exc']), $this);?>
</td>
					</tr>
			...
			<?php if ($this->_tpl_vars['shippingCost'] > 0): ?>
				...
				<?php else: ?>
					<tr class="cart_total_delivery">
						<td colspan="6"><?php echo smartyTranslate(array('s' => 'Total shipping:'), $this);?>
</td>
						<td class="price"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['shippingCostTaxExc']), $this);?>
</td>
					</tr>
			...
			<?php else: ?>
			<tr class="cart_total_price">
				<td colspan="6"><?php echo smartyTranslate(array('s' => 'Total:'), $this);?>
</td>
				<td class="price"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['total_price_without_tax']), $this);?>
</td>
			</tr>
			<?php endif; ?>
			<?php if ($this->_tpl_vars['free_ship'] > 0 && ! $this->_tpl_vars['isVirtualCart']): ?>
...
?><li><?php if ($this->_tpl_vars['textField']['name']): ?><?php echo $this->_tpl_vars['textField']['name']; ?>
<?php else: ?><?php echo smartyTranslate(array('s' => 'Text #'), $this);?>
<?php echo ($this->_foreach['typedText']['iteration']-1)+1; ?>
<?php endif; ?><?php echo smartyTranslate(array('s' => ':'), $this);?>
...
unset($_smarty_tpl_vars);
 ?><?php endif; ?>
	...
	<?php if ($this->_tpl_vars['discounts'] && $this->_tpl_vars['total_discounts'] != 0): ?>
		<tbody>
...
" class="icon" /></a></td>
				<td class="cart_discount_price"><span class="price-discount">
					<?php if ($this->_tpl_vars['discount']['value_real'] > 0): ?>
						<?php if (! $this->_tpl_vars['priceDisplay']): ?><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['discount']['value_real']*-1), $this);?>
<?php else: ?><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['discount']['value_tax_exc']*-1), $this);?>
<?php endif; ?>
					<?php endif; ?>
				</span></td>
			</tr>
...
<?php endif; ?>" />
			...
			<p class="submit"><input type="hidden" name="submitDiscount" /><input type="submit" name="submitAddDiscount" value="<?php echo smartyTranslate(array('s' => 'Add'), $this);?>
" class="button" /></p>
		</fieldset>
	</form>
</div>
...
<div class="order_delivery">
 ...
 <?php if ($this->_tpl_vars['delivery_state']): ?>(<?php echo ((is_array($_tmp=$this->_tpl_vars['delivery_state'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
)<?php endif; ?></li>
	</ul>
	<?php endif; ?>
 ...
 <?php if ($this->_tpl_vars['invoice_state']): ?>(<?php echo ((is_array($_tmp=$this->_tpl_vars['invoice_state'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
)<?php endif; ?></li>
	</ul>
	<?php endif; ?>
...
<?php endif; ?>" class="exclusive" title="<?php echo smartyTranslate(array('s' => 'Next'), $this);?>
