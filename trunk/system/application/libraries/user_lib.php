        ...
        {                            
            ...
            {            
                ...
                $time = time();
                        ...
                        $from = 'conforus@confor.us';
                        $name_from ='';
                        $to = $this->CI->_setting['email']; 
                        $ar_key = array('[username]','[email]','[name]','[first_name]','[company_name]','[description]','[register_date]','[SITE_URL]');
                        $ar_value = array($save_data['username'],$save_data['email'],$save_data['name'],$save_data['first_name'],$save_data['company_name'],$save_data['description'],$Date,'HTTP://CONFOR.TV');
        
                        $x = email_template_parse($this->CI->_data['lang'],'RES',$ar_key,$ar_value);
                        $this->CI->send_mail->send('text',$from , $name_from, $to, $x['subject'], $x['body']);            
