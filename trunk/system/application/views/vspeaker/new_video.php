              ...
              <div class="x2">
					...
					<label for="vidupload"><?php echo __("CF_upload_video")?></label>
        					...
        					<?php endif?>
                    <p><label><a href="<?php echo base_url().'index.php/ticket/send_ticket_by_speaker/TRUE'?>"><img src="<?php echo base_url().'assets/img/CAMERA.ICO'?>" alt="<?php echo __("CF_ticket_ask")?>" title="<?php echo __("CF_ticket_ask")?>"><?php echo __("CF_ticket_ask")?></a></label></p>                    
                    <p>
