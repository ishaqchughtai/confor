...
<?php foreach($video_by_cat as $rows):?>              
    ...
    <p>
        <a href="<?php echo site_url('video/play').'/'.$rows['vid_id']?>"><img alt="<?php echo $rows['title'].' - '.$rows['first_name'].' '.$rows['name']?>" title="<?php echo $rows['title'].' - '.$rows['first_name'].' '.$rows['name']?>" src="<?php echo base_url().'thumbs/'.$rows['shash']?>" width="160" height="90" class="alignleft" /></a>
    </p>
