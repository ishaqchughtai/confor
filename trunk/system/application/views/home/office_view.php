<?php
    ...
    <div class = "content_item">
        <h3><a href = "<?php echo site_url('office_frontend/office_content/'.$id)?>" title="<?php echo $title.' - Confor.tv'?>"><?php echo $title ?></a></h3>
        ...
        <a href = "<?php echo site_url('office_frontend/office_content/'.$id)?>" class = "read_more" title="<?php echo __("CF_continue").' : '.$title.' - Confor.tv'?>"><?php echo __("CF_continue") ?></a>
    </div>
