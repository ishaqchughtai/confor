			  ...
			  <div class="sidebar_item" id="search">				
				...
				<div class="sidebar_item">
					...
					<ul id="popular_posts">																	
							...
							<li>
									<a alt="<?php echo $row['title'].' - '.$row['first_name'].' '.$row['name']?>" title="<?php echo $row['title'].' - '.$row['first_name'].' '.$row['name']?>" href="<?php echo site_url('video/play').'/'.$row['vid_id']?>"><img src="<?php echo base_url().'thumbs/'.$row['shash'];?>" width="81" height="52" alt="Popular video" class="alignleft"></a>
              ...
              <div class="sidebar_item">
                    ...
                    <ul class="popular_posts_content">
								...
								<li>
									...
									<a alt="<?php echo $row['title'].' - '.$row['first_name'].' '.$row['name']?>" title="<?php echo $row['title'].' - '.$row['first_name'].' '.$row['name']?>" href="<?php echo site_url('video/play').'/'.$row['vid_id']?>">
									<img alt="<?php echo $row['title'].' - '.$row['first_name'].' '.$row['name']?>" title="<?php echo $row['title'].' - '.$row['first_name'].' '.$row['name']?>" src="<?php echo base_url().'thumbs/'.$row['shash']?>" width="81" height="52" class="alignleft">
									</a>
									<a alt="<?php echo $row['title'].' - '.$row['first_name'].' '.$row['name']?>" title="<?php echo $row['title'].' - '.$row['first_name'].' '.$row['name']?>" href="<?php echo site_url('video/play').'/'.$row['vid_id']?>" class="title"><?php echo $row['title']?></a>
									<a alt="<?php echo $row['title'].' - '.$row['first_name'].' '.$row['name']?>" title="<?php echo $row['title'].' - '.$row['first_name'].' '.$row['name']?>" href="<?php echo site_url('video/play').'/'.$row['vid_id']?>"><?php echo __("CF_view")?></a>
