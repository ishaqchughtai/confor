...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//Set variables
	public $rIdentity, $identityFound, $identityCheck = "TRUE";
	...
	public function submit(){
		...
		if ($this->voteCheck=="FALSE"){//If user has not voted, record vote
			...
			if ($this->identityCheck=="TRUE"){//Record identity
				if ($this->identityFound=="NO"){
					mysql_query("INSERT INTO ratingBans (identityList, idList) VALUES ('$this->rIdentity', '$this->uniqueRateID')");
				} else {				
					$appendString = ".";
